    ...
    Signup(){
        ...
        meter.addFocusListener(new FocusListener() { 
            ...
            public void focusLost(FocusEvent fe) {
                try {
                    Conn c = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from login where meterno = '"+meter.getText()+"'");
                    while(rs.next()) {
        ...
        if(ae.getSource() == create){
            ...
            try{
                ...
                if(atype.equals("Admin")){
                    ...
                    query = "Update login set username = '"+susername+"', password = '"+spassword+"', accountType = '"+atype+"' where meterno = '"+smeter+"'";
                }   
