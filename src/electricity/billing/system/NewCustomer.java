...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == next){
            ...
            String query1 = "insert into customer values('"+name+"', '"+meter+"', '"+address+"', '"+city+"', '"+state+"', '"+phone+"', '"+email+"')";
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Customer Details Uploaded Successfully");
                setVisible(false);
